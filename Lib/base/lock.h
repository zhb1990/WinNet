...
private:
	CCriSec(const CCriSec& cs) = delete;
	CCriSec operator = (const CCriSec& cs) = delete;
...
private:
	CCriSecSpinCount(const CCriSecSpinCount& cs) = delete;
	CCriSecSpinCount operator = (const CCriSecSpinCount& cs) = delete;
